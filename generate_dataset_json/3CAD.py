...
class CADSolver(object):
    CLSNAMES = [
        'Aluminum_Camera_Cover', 'Aluminum_Ipad', 'Aluminum_Middle_Frame', 
        'Aluminum_New_Ipad', 'Aluminum_New_Middle_Frame', 'Aluminum_Pc', 
        'Copper_Stator', 'Iron_Stator', 
    ]
...
if __name__ == '__main__':
    runner = CADSolver(root='/DDE-CLIP/data/3CAD')
    runner.run()