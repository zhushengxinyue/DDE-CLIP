...
'''
    N,C,H,W -> N,HW/1024+1,output_dim
    para: (a,b,c,d), output_dim, num_heads,   optional:(H/W, width)
'''
class ModifiedResNet(nn.Module):
    ...
    def __init__(self, layers: tuple, output_dim, heads, input_resolution=224, width=64):
        super().__init__()
...
if __name__ == '__main__':
    h = 128
    x = torch.randn(16,3,h,h)
    print('input:',x.size())
    model = VisionTransformer(h,16,8,6,8,4)
    output = model(x)
