...
📄 [CIKM'25] [DDE-CLIP: Detail-Guided Dual-Modal Enhancement for Zero-Shot Anomaly Detection](https://dl.acm.org/doi/10.1145/3746252.3761249)
...
## 🙏 Cite
If you find DDE-CLIP useful for your research and applications, please cite using this BibTeX:
```
@inproceedings{deng2025dde,
  title={DDE-CLIP: Detail-Guided Dual-Modal Enhancement for Zero-Shot Anomaly Detection},
  author={Deng, Zehao and Ma, Qingzhi and Liu, An},
